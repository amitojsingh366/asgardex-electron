...
// import THORChainApp, { extractSignatureFromTLV, HWWalletErrorType } from '@thorchain/ledger-thorchain'
...
//       return E.left({
//         errorId: HWWalletErrorId.GET_ADDRESS_FAILED,
//         msg: `Getting 'bech32Address' KeepKey THORChainApp failed`
//       })
//     }
...
//     // // Sign StdTx
//     // const { signature } = await keepkey.ThorchainSignTx(null, { data: { invocation: {} } })
...
//     if (!bech32Address || !compressedPk || returnCode !== HWWalletErrorType.NoErrors) {
//       return E.left({
