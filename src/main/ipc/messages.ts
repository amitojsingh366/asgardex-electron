enum IPCMessages {
  ...
  GET_KEEPKEY_ADDRESS = 'GET_KEEPKEY_ADDRESS',
  VERIFY_KEEPKEY_ADDRESS = 'VERIFY_KEEPKEY_ADDRESS',
  SEND_KEEPKEY_TX = 'SEND_KEEPKEY_TX',
  DEPOSIT_KEEPKEY_TX = 'DEPOSIT_KEEPKEY_TX',
